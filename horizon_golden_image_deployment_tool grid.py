...
VDI_Connect_Button.grid(row=2, column=4, padx=5, pady=5, sticky='nsew')
...
VDI_Apply_Golden_Image_button.grid(row=14, column=3, padx=5, pady=5, sticky='nsew' )
...
VDI_Apply_Secondary_Image_button.grid(row=12, column=3, padx=5, pady=5, sticky='nsew')
...
VDI_Cancel_Secondary_Image_button.grid(row=11, column=3, padx=5, pady=5, sticky='nsew')
...
VDI_Promote_Secondary_Image_button.grid(row=13, column=3, padx=5, pady=5, sticky='nsew')

# Create Labels
VDI_Statusbox_Label = ttk.Label(
    tab1, borderwidth=1, text="Status: Not Connected", anchor="w", justify="right")
VDI_Statusbox_Label.grid(row=14, column=1,columnspan=2, padx=5, pady=5, sticky='nsew')

VDI_DesktopPool_Label = ttk.Label(
    tab1, borderwidth=1, text="Desktop Pool", justify="right")
VDI_DesktopPool_Label.grid(row=1, column=1, padx=5, pady=5)

VDI_Golden_Image_Label = ttk.Label(
    tab1, borderwidth=1, text="Source VM", justify="right")
VDI_Golden_Image_Label.grid(row=1, column=2, padx=5, pady=5)

VDI_Snapshot_Label = ttk.Label(
    tab1, borderwidth=1, text="Source Snapshot", justify="right")
VDI_Snapshot_Label.grid(row=1, column=3, padx=5, pady=5)

VDI_hour_label = ttk.Label(tab1, text="Hour:")
VDI_hour_label.grid(row=8, column=4, padx=5, pady=5, sticky='nsw')

VDI_minute_label = ttk.Label(tab1, text="Minute:", anchor='w')
VDI_minute_label.grid(row=8, column=4, padx=5, pady=5)

VDI_CAL_label = ttk.Label(tab1, text="Date:")
VDI_CAL_label.grid(row=6, column=4, padx=5, pady=5, sticky='nsw')

VDI_Memory_label = ttk.Label(tab1, text="Memory Size")
VDI_Memory_label.grid(row=5, column=3, padx=5, pady=5)

VDI_CPUCount_label = ttk.Label(tab1, text="Total Cores Count")
VDI_CPUCount_label.grid(row=7, column=3, padx=5, pady=5)

VDI_CoresPerSocket_label = ttk.Label(tab1, text="Cores Per Socket")
VDI_CoresPerSocket_label.grid(row=9, column=3, padx=5, pady=5)

VDI_secondary_image_machine_options_label = ttk.Label(
    tab1, text="Secondary Image Options")
VDI_secondary_image_machine_options_label.grid(row=11, column=4, padx=5, pady=5, columnspan=2)
...
VDI_secondary_image_machine_count_label.config(
    text=VDI_secondary_image_machine_count_label_default)
VDI_secondary_image_machine_count_label.grid(row=13, column=4, padx=5, pady=5)
...
VDI_DesktopPool_Combobox.grid(row=2, column=1, padx=5, pady=5)
...
VDI_Golden_Image_Combobox.grid(row=2, column=2, padx=5, pady=5)
...
VDI_Snapshot_Combobox.grid(row=2, column=3, padx=5, pady=5)
...
VDI_LofOffPolicy_Combobox.grid(row=3, column=3, padx=5, pady=5)
...
VDI_Memory_ComboBox.grid(row=6, column=3, padx=5, pady=5)
...
VDI_CPUCount_ComboBox.grid(row=8, column=3, padx=5, pady=5)
...
VDI_CoresPerSocket_ComboBox.grid(row=10, column=3, padx=5, pady=5)
...
VDI_Secondary_Machine_Options_Combobox.grid(row=12, column=4, padx=5, pady=5)
...
VDI_secondaryimage_checkbox.grid(row=10, column=4, padx=5, pady=5, sticky='nsw')
...
VDI_StopOnError_checkbox.grid(row=4, column=4, padx=5, pady=5, sticky='nsw')
...
VDI_Resize_checkbox.grid(row=4, column=3, padx=5, pady=5, sticky='nsw')
...
VDI_vtpm_checkbox.grid(row=3, column=4, padx=5, pady=5, sticky='nsw')
...
VDI_Enable_datetimepicker_checkbox.grid(row=5, column=4, padx=5, pady=5, sticky='nsw')
...
VDI_Status_Textblock.grid(row=2, column=1, padx=5, pady=5, columnspan=2, rowspan=12)
...
RDS_Connect_Button.grid(row=2, column=4, padx=5, pady=5, sticky='nsew')
...
RDS_Apply_Golden_Image_button.grid(row=14, column=3, padx=5, pady=5, sticky='nsew' )
...
RDS_Apply_Secondary_Image_button.grid(row=12, column=3, padx=5, pady=5, sticky='nsew' )
...
RDS_Cancel_Secondary_Image_button.grid(row=11, column=3, padx=5, pady=5, sticky='nsew')
...
RDS_Promote_Secondary_Image_button.grid(row=13, column=3, padx=5, pady=5, sticky='nsew')

# Create Labels
RDS_Statusbox_Label = ttk.Label(
    tab2, borderwidth=1, text="Status: Not Connected", anchor="w", justify="right")
RDS_Statusbox_Label.grid(row=14, column=1,columnspan=2, padx=5, pady=5, sticky='nsew')

RDS_Farm_Label = ttk.Label(
    tab2, borderwidth=1, text="RDS Farm", justify="right")
RDS_Farm_Label.grid(row=1, column=1, padx=5, pady=5)

RDS_Golden_Image_Label = ttk.Label(
    tab2, borderwidth=1, text="Source VM", justify="right")
RDS_Golden_Image_Label.grid(row=1, column=2, padx=5, pady=5)

RDS_Snapshot_Label = ttk.Label(
    tab2, borderwidth=1, text="Source Snapshot", justify="right")
RDS_Snapshot_Label.grid(row=1, column=3, padx=5, pady=5)

RDS_hour_label = ttk.Label(tab2, text="Hour:")
RDS_hour_label.grid(row=8, column=4, padx=5, pady=5, sticky='nsw')

RDS_minute_label = ttk.Label(tab2, text="Minute:", anchor='w')
RDS_minute_label.grid(row=8, column=4, padx=5, pady=5)

RDS_CAL_label = ttk.Label(tab2, text="Date:")
RDS_CAL_label.grid(row=6, column=4, padx=5, pady=5, sticky='nsw')

RDS_Memory_label = ttk.Label(tab2, text="Memory Size")
RDS_Memory_label.grid(row=5, column=3, padx=5, pady=5)

RDS_CPUCount_label = ttk.Label(tab2, text="Total Cores Count")
RDS_CPUCount_label.grid(row=7, column=3, padx=5, pady=5)

RDS_CoresPerSocket_label = ttk.Label(tab2, text="Cores Per Socket")
RDS_CoresPerSocket_label.grid(row=9, column=3, padx=5, pady=5)

RDS_secondary_image_machine_options_label = ttk.Label(
    tab2, text="Secondary Image Options")
RDS_secondary_image_machine_options_label.grid(row=11, column=4, padx=5, pady=5)
...
RDS_secondary_image_machine_count_label.grid(row=13, column=4, padx=5, pady=5)

# Create ComboBoxes
RDS_Farm_Combobox_var = tk.StringVar()
RDS_Farm_Combobox = ttk.Combobox(
    tab2, state="disabled", textvariable=RDS_Farm_Combobox_var)
RDS_Farm_Combobox.grid(row=2, column=1, padx=5, pady=5)
...
RDS_Golden_Image_Combobox.grid(row=2, column=2, padx=5, pady=5)
...
RDS_Snapshot_Combobox.grid(row=2, column=3, padx=5, pady=5)
...
RDS_LofOffPolicy_Combobox.grid(row=3, column=3, padx=5, pady=5)
...
RDS_Memory_ComboBox.grid(row=6, column=3, padx=5, pady=5)
...
RDS_CPUCount_ComboBox.grid(row=8, column=3, padx=5, pady=5)
...
RDS_CoresPerSocket_ComboBox.grid(row=10, column=3, padx=5, pady=5)
...
RDS_Secondary_Machine_Options_Combobox.grid(row=12, column=4, padx=5, pady=5)
...
RDS_secondaryimage_checkbox.grid(row=10, column=4, padx=5, pady=5,sticky='nsw')
...
RDS_StopOnError_checkbox.grid(row=4, column=4, padx=5, pady=5, sticky='nsw')
...
RDS_Resize_checkbox.grid(row=4, column=3, padx=5, pady=5, sticky='nsw')
...
RDS_Enable_datetimepicker_checkbox.grid(row=5, column=4, padx=5, pady=5, sticky='nsw')
...
config_username_textbox.grid(row=4, column=1, padx=5, pady=5, sticky='nsew')
...
config_domain_textbox.grid(row=6, column=1, padx=5, pady=5, sticky='nsew')

# Create Labels
config_conserver_label = ttk.Label(tab3, text="Connection Server")
config_conserver_label.grid(row=1, column=1, padx=5, pady=5, )

config_pod_label = ttk.Label(tab3, text="Pod")
config_pod_label.grid(row=1, column=2, padx=5, pady=5)

config_username_label = ttk.Label(tab3, text="Username")
config_username_label.grid(row=3, column=1, padx=5, pady=5)

config_domain_label = ttk.Label(tab3, text="Domain")
config_domain_label.grid(row=5, column=1, padx=5, pady=5)

config_status_label = ttk.Label(tab3, text="Status: N/A")
config_status_label.grid(row=12, column=1, padx=5, pady=5 )

# Create ComboBoxes
config_pod_combobox = ttk.Combobox(tab3)
config_pod_combobox.grid(row=2, column=2, padx=5, pady=5, sticky='nsew')
...
config_conserver_combobox.grid(row=2, column=1, padx=5, pady=5, sticky='nsew')
...
config_save_password_checkbox.grid(row=8, column=1, padx=5, pady=5, sticky='nsew')
